...
<?php endif; ?>
<?php if ($heading_font) : ?>
	h1, h2, h3, h4, h5, h6, .homeSection h3, #pageHead h1, .widgetBox span.title { font-family: '<?php echo $heading_font; ?>' !important; }
<?php endif; ?>
...
<?php if ($slideshow_heading_font) : ?>
	.home .slideshow h1,.home .slideshow h2,.home .slideshow h3,.home .slideshow h4,.home .slideshow h5 { font-family: '<?php echo $slideshow_heading_font; ?>' !important; }
<?php endif; ?>
<?php if ($slideshow_body_font) : ?>
	.home .slideshow p { font-family: '<?php echo $slideshow_body_font; ?>'; }
<?php endif; ?>
...
<?php if(of_get_option('ttrust_color_home_message_bkg')) : ?>
	#homeMessage {
		background-color: <?php echo(of_get_option('ttrust_color_home_message_bkg')); ?>;
	}	
<?php endif; ?>
...
add_image_size('ttrust_project_thumb', 570, 455, true);
