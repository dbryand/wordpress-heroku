...
?>
	...
	?></p>
		<p class="sumk-variables description"><?php _e( 'You can use next variables', $sumk->textdomain ); ?>: <span></span><br /><?php _e( 'They will be replaced with shortcode content and attributes values', $sumk->textdomain ); ?></p>
		<p><textarea class="large-text code" name="sumk_code" id="sumk-code-field" cols="30" rows="10"><?php echo stripslashes( get_post_meta( $post->ID, 'sumk_code', true ) ); ?></textarea></p>
			<div id="sumk-code-field-editor"></div>
	</div>
	<div class="sumk-field sumk-clearfix misc-pub-section">
		<p class="alignright"><input name="save" type="submit" class="button button-primary button-large" id="publish" accesskey="p" value="<?php _e( 'Submit', 'sumk' ); ?>" /></p>
	</div>
